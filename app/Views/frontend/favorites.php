...
<div class="bg-white dark:bg-neutral-900 border-b dark:border-neutral-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 class="text-3xl font-bold text-neutral-900 dark:text-white">My Favorites</h1>
        <p class="text-neutral-600 dark:text-neutral-400 mt-2"><?= number_format($total) ?> saved images</p>
    </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="text-center py-16">
        ...
        <h3 class="mt-4 text-lg font-medium text-neutral-900 dark:text-white">No favorites yet</h3>
        <p class="mt-2 text-neutral-600 dark:text-neutral-400">Browse the gallery and save images you love.</p>
    ...
    <div class="gallery-grid grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        ...
        <div class="group relative">
            ...
            <p class="text-xs text-neutral-500 dark:text-neutral-400 mt-1">Saved <?= date('M j, Y', strtotime($image['favorited_at'])) ?></p>
        </div>
        <?php endforeach; ?>
    </div>
    ...
    <nav class="mt-8 flex justify-center">
        <div class="flex items-center gap-2">
            <?php if ($page > 1): ?>
            <a href="<?= $view->url('/favorites') ?>?page=<?= $page - 1 ?>" class="px-4 py-2 bg-white dark:bg-neutral-800 border dark:border-neutral-600 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 dark:text-white">Previous</a>
            <?php endif; ?>
            ...
            <a href="<?= $view->url('/favorites') ?>?page=<?= $page + 1 ?>" class="px-4 py-2 bg-white dark:bg-neutral-800 border dark:border-neutral-600 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 dark:text-white">Next</a>
            <?php endif; ?>
        </div>
    </nav>
    <?php endif; ?>
